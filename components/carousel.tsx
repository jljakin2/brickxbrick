...
import Carousel01 from "@/public/images/avatar-01.jpg";
  ...
  return (
    <section className="">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <h2 className="text-3xl md:text-4xl  font-hkgrotesk font-extrabold mb-4 md:mb-2">
          Top Episodes
        </h2>
        <div className="relative">
          {/* Background */}
          <div
            className="absolute inset-0 bg-gray-100 rounded-3xl -mx-20 -z-10"
            aria-hidden="true"
          />

          {/* Sparkles */}
          <div className="absolute top-0 -mt-6 left-1/2">
            <svg xmlns="http://www.w3.org/2000/svg" width="70" height="50">
              <g fill="#ef3047" fillRule="nonzero">
          ...
          <div className="py-12 md:py-20 -mx-20 px-20 overflow-hidden">
            ...
            <div className="carousel swiper-container">
              <div className="swiper-wrapper">
                    ...
                    <div className="group-odd:rotate-1 group-even:-rotate-1">
                      <div className="absolute inset-0 -z-10">
                        {/* <Image
                          ...
                          alt="Carousel 02"
                        /> */}
                        <div className="min-h-[50px] bg-white w-full h-full rounded-3xl" />
                      </div>
                      <div className="p-5 pb-14">
                        <div className="font-hkgrotesk font-extrabold text-black text-xl leading-tight mb-1">
                          How To Find My First SaaS Customers{" "}
                        </div>
                        <div className="font-hkgrotesk text-black font-medium text-sm opacity-80 mb-4">
                          Deep Dives · Apr 29 · Episode 003
                        </div>
                        {/* <Image
                          src={Play}
                          width={48}
                    ...
                    <div className="group-odd:rotate-1 group-even:-rotate-1">
                      <div className="absolute inset-0 -z-10">
                        {/* <Image
                          ...
                          alt="Carousel 03"
                        /> */}
                        <div className="min-h-[50px] bg-[#ef3047] w-full h-full rounded-3xl" />
                      </div>
                      <div className="p-5 pb-14">
                        <div className="font-hkgrotesk font-extrabold text-white text-xl leading-tight mb-1">
                          Seventeen Year-Old Builds SaaS Company With Industry
                          Experts{" "}
                        </div>
                        <div className="font-hkgrotesk text-white font-medium text-sm opacity-80 mb-4">
                          Interviews · May 6 · Episode 004
                        </div>
                        {/* <Image
                          src={Play}
                          width={48}
                ...
                <div className="swiper-slide h-auto flex flex-col max-w-[446px] group">
                  <Link href="/army-officer-to-tech-founder">
                    <div className="group-odd:rotate-1 group-even:-rotate-1">
                      <div className="absolute inset-0 -z-10">
                        {/* <Image
                          className="w-full object-cover rounded-3xl"
                      ...
                      <div className="p-5 pb-14">
                        <div className="font-hkgrotesk font-extrabold text-white text-xl leading-tight mb-1">
                          From Army Officer to Tech Entrepreneur: The Story of
                          Stitch3D and the 3D Revolution{" "}
                        </div>
                        <div className="font-hkgrotesk text-white font-medium text-sm opacity-80 mb-4">
                          Interviews · May 13 · Episode 005
                        </div>
                        {/* <Image
                          src={Play}
                          width={48}
            ...
            <div className="flex mt-12 space-x-3 justify-end">
              <button className="carousel-prev relative z-20 w-11 h-11 rounded-full flex items-center justify-center group bg-white hover:bg-red-100 transition duration-150 ease-in-out">
                <span className="sr-only">Previous</span>
                <svg
                  className="w-4 h-4 fill-black transition duration-150 ease-in-out"
                  viewBox="0 0 16 16"
              ...
              <button className="carousel-next relative z-20 w-11 h-11 rounded-full flex items-center justify-center group bg-white hover:bg-red-100 transition duration-150 ease-in-out">
