    ...
    <section>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="relative">
          {/* Background */}
          <div
            className="absolute inset-0 bg-black rounded-3xl -mx-20 -z-10"
            aria-hidden="true"
          >
            {" "}
          </div>
          ...
          {/* Sparkles */}
          {/* <div
            className="absolute top-0 left-1/2 -trangray-x-1/2 mt-14 pointer-events-none -z-10 hidden lg:block"
            aria-hidden="true"
          >
          ...
          {/* Scratches */}
          {/* <div
            className="absolute top-full left-1/2 -trangray-x-1/2 -mt-4 pointer-events-none -z-10"
            aria-hidden="true"
          >
          ...
          <div className="py-12 md:py-20 -mx-20 px-20 overflow-hidden">
            <div className="lg:flex items-start">
              ...
              <div className="flex-1 mb-12 lg:mb-0">
                <div className="mb-6">
                  <h2 className="text-3xl md:text-4xl font-hkgrotesk font-extrabold text-gray-100 mb-2">
                    Meet Your Hosts
                  </h2>
                  <div className="text-gray-400 space-y-3">
                    <p>Learn to build and sell profitable SaaS products.</p>
                    <p>
                      Join Mike and Jeff as they explore all the skills you need
                      to build SaaS products and go from your first customer to
                      acquisition.
                    </p>
                    <p>
                      You'll learn new frameworks, hear about the latest tools
                      and techniques for growing SaaS businesses, and hear from
                      current founders who are building the latest products from
                      many industries.
                    </p>
                  </div>
                </div>
                <div className="border-t pt-8 mb-8">
                  <p className="italic text-gray-200 pb-8">
                    "Working with Mike helped me make important marketing and
                    sales decisions. He always preferred building sustainable
                    systems to scale over time rather than doing overwhelming
                    tasks"
                  </p>
                  <div className="flex items-center">
                    {/* <Image
                      ...
                      alt="Promoter"
                    /> */}
                    <div className="font-permanent-marker text-gray-300 text-sm uppercase">
                      — Vic Giurgiu <br />
                      Founder of {/* open in new tab */}
                      <a
                ...
                <div>
                  <Link
                    className="btn text-white bg-red-500 hover:bg-red-600 group shadow-sm"
                    href="/subscribe"
                  >
                    Subscribe{" "}
                    <span className="tracking-normal text-red-300 group-hover:trangray-x-0.5 transition-transform duration-150 ease-in-out ml-1">
                      -&gt;
                    </span>
                  </Link>
                </div>
              ...
              <div className="lg:w-[640px] lg:ml-12 xl:ml-20">
                <div className="space-y-12 lg:space-y-20">
                  ...
                  <div className="flex items-start">
                    <Image
                      className="mr-6 rounded-full border-4 border-white"
                      src={Mike}
                      width={153}
                      height={130}
                    ...
                    />
                    <div>
                      <div className="text-lg font-hkgrotesk font-extrabold text-gray-100">
                        Mike Blumenthal
                      </div>
                      <div className="mb-2">
                        <a
                          className="font-hkgrotesk font-medium text-sm text-red-500 hover:underline"
                      ...
                      <div className="text-gray-400">
                        <p className="mb-2">
                          Mike is an up-and-coming entrepreneur in the
                          tech scene.
                        </p>
                        <p className="mb-2">
                          He works with founders to build and scale their tech
                          companies leveraging proven lead-generation methods.
                          {/* His first SaaS buildout started at 20 years old and
                          over the last 8 years his team has developed and
                          scaled dozens of tech companies with seasoned
                          entrepreneurs. */}
                        </p>
                        <p className="mb-2">
                          Mike's unique 
                          <a
                            href="http://saasleadflow.io/"
                            target="_blank"
                            rel="noopener noreferrer"
                          ...
                           process helps leaders focus more on the business
                          while he scales up lead generation teams to bring in
                          more leads, revenue, and pipeline.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <div className="text-gray-400">
                        <p className="mb-2">
                          Jeff is a full-stack developer with a background in
                        ...
                        <p className="mb-2">
                          ...
                          as Lead Developer and Product Manager.
                        </p>
                        <p className="mb-2">
                          His passion is building high-leverage SaaS products
                          with curious people in motion. Check out{" "}
                          <a
                            href="https://jeffbuildstech.com/"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="underline underline-offset-4 hover:text-gray-100"
                          >
