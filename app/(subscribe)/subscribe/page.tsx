        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="pt-16 md:pt-40">
            <div className="relative">
              ...
              >
                {/* Illustration */}
                <div className="absolute -top-24 left-2/3 -translate-x-1/3 md:-translate-x-1/2 pointer-events-none -z-10 blur-2xl">
                  <svg
              ...
              <div className="py-12 md:py-20 -mx-20 px-20">
                <div className="max-w-3xl mx-auto text-center">
                  ...
                  <div className="-m-1.5 max-w-xl mx-auto mb-8">
                    <button className="btn text-white bg-red-500 hover:bg-red-600 group shadow-sm m-1.5">
                      <a
                        href="https://podcasts.apple.com/us/podcast/brick-by-brick/id1740570090"
                        target="_blank"
                    ...
                    <button className="btn text-white bg-red-500 hover:bg-red-600 group shadow-sm m-1.5">
                      <a
                        href="https://open.spotify.com/show/75N6W0GmYiQicXNaE4NDqu?si=41f63093cdb24991"
                        target="_blank"
                        rel="noopener noreferrer"
                      >
                        Spotify
                    ...
                    <button className="btn text-white bg-red-500 hover:bg-red-600 group shadow-sm m-1.5">
                      <a
                        href="https://music.amazon.com/podcasts/c2ba1997-64e7-4710-bb99-0523cf80aa74/brick-by-brick"
                        target="_blank"
                        rel="noopener noreferrer"
                      >
                        Amazon Music
