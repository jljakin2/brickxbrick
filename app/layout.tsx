...
export const metadata = {
  title: "Brick by Brick podcast",
  description:
    "Welcome to Brick by Brick podcast, where we talk about everything you need to know to build and sell profitable SaaS products.",
};
